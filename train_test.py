...
libri_dir = "/libri2mix"
model_volume = Volume.from_name("test-rotatetion", create_if_missing=True)
model_dir = "/model"
...
def test_train():
    ...
    from WHYV2.criterion.si_sdr import SingleSrcNegSDRScaledEst
    ...
    train_dataset = Libri2MixWithAsteroid(
        ...
        embeddings_dir='/libri2mix/embedding_train-100_mix_both.csv'
    )

    val_dataset = Libri2MixWithAsteroid(
        ...
        segment=4,
        return_embeddings=True,
        embeddings_dir='/libri2mix/embedding_dev_mix_both.csv'
    )

    # test_dataset = Libri2MixWithAsteroid(
    #     csv_dir='/libri2mix/Libri2Mix/wav8k/min/metadata/test',
    #     task="sep_noisy",
    #     sample_rate=8000,
    #     n_src=2,
    #     segment=4,
    #     return_embeddings=True,
    #     embeddings_dir='/libri2mix/embedding_test_mix_both.csv'
    # )

    model = WHYVwithRotateCondition(n_layers=5, conditional_dim=256)
    def commit_func():
        model_volume.commit()
        ...
        def train_iter(self,epoch,start_time):
            ...
            for data in self.train_loader:
                with autocast(device_type='cuda',enabled=False):
                    ...
                    emb0 = emb0.to(self.device).float()
                    num_batch += 1
    ...
    pipeline = Pipeline(
        ...
        checkpoint_name="whyv_with_rotate.pth",
        checkpoint_rate=1,
        patient=2,
        checkpoint_from_epoch=1,
